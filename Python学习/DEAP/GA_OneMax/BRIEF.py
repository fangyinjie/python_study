...
ONE_MAX_LENGTH = 100  # 优化的bit字符串的长度
...
if __name__ == "__main__":
    ...
    toolbox.register("individualCreator", tools.initRepeat, creator.Individual,  # (1) 将creator.Individual类作为放置结果对象的容器类型
                     toolbox.zeroOrOne,  # (2) zeroOrOne操作是生成对象的函数
                     ONE_MAX_LENGTH)  # (3) 常量ONE_MAX_LENGTH作为要生成的对象数目
