...
if __name__ == "__main__":
    ...
    # inputs = read_dag('test.dot', p=3)
    # inputs = read_dag('test.dot', p=3)
    print('No. of nodes: {}\nNo. pf processors: {}\nComputation Matrix:\n{}\nAdjacency Matrix:\n{}\n'.format(
        n_nodes, p, comp_matrix, adj_matrix))
    inputs = n_nodes, p, comp_matrix, adj_matrix
    makespan_HEFT = hf.HEFT(input_list=inputs).makespan
    print(makespan_HEFT)
    # makespan_prop = randomHEFT(input_list=inputs).makespan
    # makespan_IPEFT = IPEFT(input_list=inputs).makespan
    # print(f'makespan_HEFT:{makespan_HEFT}')
    # print(f'makespan_prop:{makespan_prop}')
    # print(f'makespan_IPEFT:{makespan_IPEFT}')
